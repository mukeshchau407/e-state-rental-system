                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-success text-left m-0 text-md-left">
                                            NPR.<?php echo $row['13']; ?></div>
                                ...
                                <div class="property-details">
                                    ...
                                    <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative"
                                        id="book_now">Contact
                                        Agent</h5>
                        ...
                        <form method="post" action="#">
                            ...
                            <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">ENTER PAYMENT
                            </h4>
                            <form class="d-inline-block w-100" action="calc.php" method="post">
                                ...
                                <button type="submit" value="submit" name="calc"
                                    class="btn btn-success mt-4 form-control">Check</button>
                            </form>
