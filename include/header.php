<header id="header" class="transparent-header-modern fixed-header-bg-white w-100">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <ul class="top-contact list-text-white  d-table">
                                <li><a href="#"><i class="fas fa-phone-alt text-success mr-1"></i>+977 980000000</a></li>
                                <li><a href="#"><i class="fas fa-envelope text-success mr-1"></i>welthome@helpline.com</a></li>
                            </ul>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="main-nav secondary-nav hover-success-nav py-1">
                <div class="container-expand-lg rounded">
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg navbar-light bg-warning px-4">
                                <a class="navbar-brand position-relative" href="index.php"><img class="nav-logo" src="images/logo.png" alt=""></a>
