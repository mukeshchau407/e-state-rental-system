...
include ("config.php");
$aid = $_GET['aid'];
$sql = "UPDATE `admin` SET `aid`='',`auser`='',`aemail`='',`apass`='',`adob`='',`aphone`='' WHERE aid = '$aid'";
$result = mysqli_query($con, $sql);
if ($result == true) {
    $msg = "<p class='alert alert-success'>Admin Updated</p>";
    header("Location:adminlist.php?msg=$msg");
} else {
    $msg = "<p class='alert alert-warning'>Admin Not Updated</p>";
    header("Location:adminlist.php?msg=$msg");
}
mysqli_close($con);
?>
...
<head>
    ...
    <title>welthome - Vertical Form</title>
