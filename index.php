                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-lg-12">
                            <div class="text-white">
                                <h1 class="mb-4"><span class="text-success">Find Your Dream Home</span><br>
                                    Where You Can Be YourSelf.</h1>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="featured-thumb hover-zoomer mb-4">
                                                <div class="overlay-black overflow-hidden position-relative"> <img
                                                    ...
                                                    <div class="price text-primary"><b>NPR.
                                                            <?php echo $row['13']; ?>
                                                ...
                                                <div class="featured-thumb-data shadow-one">
                                                    <div class="p-3">
                                                        <h5
                                                            class="text-secondary hover-text-success mb-0 text-capitalize d-flex justify-content-between">
